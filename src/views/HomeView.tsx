          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center text-left">
            <div className="space-y-6">
              ...
              <p className="text-sm text-neutral-600 leading-relaxed">
                Most commercial tees use flimsy 140–160 GSM fabrics that collapse after two washes. At AURA THREADS, we exclusively spin 240 GSM extra-long staple combed cotton and French Terry knits.
              </p>
              ...
              <div className="space-y-5 text-sm">
                ...
                <div className="flex items-start gap-3.5">
                  ...
                  <div>
                    ...
                    <a href="mailto:contact@aurathreads.com" className="text-base font-bold text-neutral-950 hover:underline">
