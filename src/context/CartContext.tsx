...
export const CartProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  // Coupons
  const [appliedCoupon, setAppliedCoupon] = useState<string | null>('TEEZOON30');
  ...
  const applyCoupon = (code: string) => {
    ...
    if (cleanCode === 'TEEZOON30' || cleanCode === 'SWAMI30' || cleanCode === 'AURA30') {
      setAppliedCoupon('TEEZOON30');
      ...
      showToast('Invalid Coupon Code', 'Please try TEEZOON30 or FIRST10', 'error');
  ...
  if (appliedCoupon === 'TEEZOON30' || appliedCoupon === 'SWAMI30' || appliedCoupon === 'AURA30') {
